...
class SplatfactoModel(Model):
    ...
    def get_loss_dict(self, outputs, batch, metrics_dict=None) -> Dict[str, torch.Tensor]:
        ...
        if "mask" in batch:
            ...
            '''img = transform(gt_img.permute(2,0,1))
            img.save("/var/scratch/bmocal/projects/synthesis/{}_gt2.png".format(1))
            img2 = transform(pred_img.permute(2,0,1))
            img2.save("/var/scratch/bmocal/projects/synthesis/{}_pred2.png".format(1))'''

        '''transform = transforms.ToPILImage()
        img = transform(gt_img.permute(2, 0, 1))
        img.save("/var/scratch/bmocal/projects/synthesis/{}_gt.png".format(1))
        img = transform(pred_img.permute(2, 0, 1))
        img.save("/var/scratch/bmocal/projects/synthesis/{}_pred.png".format(1))'''
